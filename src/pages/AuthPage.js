  ...
  return (
    <div className="auth-page">
      <div className="auth-box">
        <div className="auth-logo">📚 CampusMart</div>
        <div className="auth-tagline">Buy, sell & share within your campus</div>
            ...
            <div className="form-row">
              <div className="form-group">
                ...
                <select className="form-input" value={branch} onChange={e => setBranch(e.target.value)}>
                  ...
                  <option>Chemical</option><option>MBA</option><option>Other</option>
                </select>
              </div>
              <div className="form-group">
