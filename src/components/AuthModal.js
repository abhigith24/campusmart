      ...
      <div className="modal" style={{ position: "relative", maxWidth: 450, padding: "30px 24px" }}>
        ...
        {tab !== "forgot" ? (
          <>
            ...
            <div className="auth-tabs" style={{ display: "flex", background: "var(--light)", padding: 4, borderRadius: 10, marginBottom: 16 }}>
              <button
                className={`auth-tab ${tab === "login" ? "active" : ""}`}
                onClick={() => { setTab("login"); setError(""); }}
                type="button"
                style={{ flex: 1, padding: "8px 12px", border: "none", background: tab === "login" ? "#fff" : "transparent", borderRadius: 8, fontSize: 13, fontWeight: 700 }}
              >
                Sign In
              </button>
              <button
                ...
                type="button"
                style={{ flex: 1, padding: "8px 12px", border: "none", background: tab === "signup" ? "#fff" : "transparent", borderRadius: 8, fontSize: 13, fontWeight: 700 }}
              >
                Sign Up
              </button>
            </div>

            <button className="google-btn" onClick={handleGoogle} disabled={loading} type="button" style={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "center", gap: 10, padding: 10, border: "1.5px solid var(--bdr)", borderRadius: 8, background: "#fff", fontWeight: 700, fontSize: 13, cursor: "pointer", marginBottom: 16 }}>
